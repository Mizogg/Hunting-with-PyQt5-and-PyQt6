...
class GUI(QWidget):
    ...
    def initUI(self):
        ...
        self.setGeometry(920, 100, 200, 10)
        self.setWindowTitle('Hunter QT with Mizogg HEX Version')
...
class GUIInstance(QWidget):
    ...
    def initUI(self):
        ...
        # Create a label and line edit for the HEX start value
        ...
        # Create a label and line edit for the HEX end value
